...
function scanFileContent(relPath, content, caps, collect, context, install, analyzed = null) {
  ...
  if (analyzed && analyzed.parsed) recordAstCapabilities(relPath, content, analyzed.references, caps, context);
...
function scanPackageDir(dir, options = {}) {
  ...
  const astCoverage = parser ? { parser: `acorn@${parser.version}`, complete: true, filesAnalyzed: 0, filesFailed: 0, errors: [] } : null;
