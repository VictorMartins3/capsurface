...
const CATEGORIES = [
  ...
  { key: 'networkRequest', label: 'HTTP requests', parent: 'network', severity: 0, patterns: [] },
  { key: 'networkConnect', label: 'Network or IPC connections', parent: 'network', severity: 0, patterns: [] },
  { key: 'networkServer', label: 'Network server creation', parent: 'network', severity: 0, patterns: [] },
  { key: 'networkDns', label: 'DNS queries', parent: 'network', severity: 0, patterns: [] },
  { key: 'networkSocket', label: 'UDP socket creation', parent: 'network', severity: 0, patterns: [] },
  {
    key: 'exec',
  ...
  // Deep-mode call detail; the parent retains the process risk score.
  { key: 'execShell', label: 'Shell execution', parent: 'exec', severity: 0, patterns: [] },
  { key: 'execDirect', label: 'Direct process launch', parent: 'exec', severity: 0, patterns: [] },
  { key: 'execUnresolved', label: 'Unresolved process launch mode', parent: 'exec', severity: 0, patterns: [] },
  {
    key: 'env',
  ...
  { key: 'envEnumeration', label: 'Environment enumeration', parent: 'env', severity: 0, patterns: [] },
  {
    key: 'dynamicEval',
